...
#define ImageViewWidthRatio 0.56
#define ImageViewWidhtHeightRatio 0.84
...
-(instancetype)initWithImageURL:(NSString *)str AndClickCallBack:(ClickCallBack)clickCallBack andCloseCallBack:(CloseCallBack)closeCallBack
{
    if (self = [super init]) {
        [self dl_setupNewWindow];
        [self dl_setupImageViewWithImageUrl:str];
...
-(void)dl_setupImageViewWithImageUrl:(NSString *)str
{
